...
// Cargar analíticas de la empresa
const { data: dashboard, pending, error } = await useAsyncData('dashboard:company', () => 
...
<template>
  <div class="space-y-6">
    <div v-if="authContext?.role === 'SUPER_ADMIN'" class="text-slate-500 text-sm">
      Redirigiendo al dashboard global...
    </div>
    
    <div v-else-if="authContext?.role === 'GATE_STAFF'" class="text-slate-500 text-sm">
      Redirigiendo al escáner de control de acceso...
    </div>
    ...
    <div v-else class="space-y-6">
      ...
      <div v-else class="space-y-6">
        ...
        <!-- Fila secundaria: Próximo Evento y Estado de Ocupación -->
